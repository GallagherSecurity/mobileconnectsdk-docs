...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate, LogWriter {
    ...
    override init() {
        ...
        mobileAccess = MobileAccessProvider.configure(
            // the sample app enables both Salto and Digital ID. If you don't want those you can use [] or simply don't supply enabledFeatures at all
            enabledFeatures: [.digitalId, .salto]
        )
